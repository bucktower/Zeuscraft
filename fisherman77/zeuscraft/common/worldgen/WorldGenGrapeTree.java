...
public class WorldGenGrapeTree extends WorldGenerator implements IWorldGenerator
{
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		if (par4 >= 1 && par4 + l + 1 <= 256)
		{
			...
			else
			{
				...
				boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockGrapeSapling)Zeuscraft.GrapeSapling));
				if (isSoil && par4 < 256 - l - 1)
				{
						...
						for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
						{
							...
							for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
							{
								...
								if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
								{
									...
									{
										/** Custom leaf block **/
										this.setBlockAndMetadata(par1World, j2, j1, l2, Zeuscraft.GrapeLeaves.blockID, this.metaLeaves);
									}
								}
							}
						}
					...
					for (j1 = 0; j1 < l; ++j1)
					{
						...
						{
							/** Custom Log block **/
							this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, Zeuscraft.GrapeLog.blockID, this.metaWood);
						}
					}
