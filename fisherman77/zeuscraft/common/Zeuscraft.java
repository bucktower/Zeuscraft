...
//ACHIEVEMENTS
	...
	public void PreInit(FMLPreInitializationEvent e)
	{
		...
		//BLOCKS
				...
				//MinotaurHead = (new BlockMinotaurHead(cc.blockMinotaurHeadID).setUnlocalizedName("MinotaurHead"));
				OlympusPortal = (new BlockOlympusPortal(cc.blockOlympusPortalID, 1).setUnlocalizedName("OlympusPortal"));
		...
		//ITEMS
				...
				CBronzeAxe = new ItemCBronzeAxe(cc.toolCBronzeAxeID, celestialBronze).setUnlocalizedName("CBronzeAxe");
				CBronzeHoe = new ItemCBronzeHoe(cc.toolCBronzeHoeID, celestialBronze).setUnlocalizedName("CBronzeHoe");
				CBronzeIngot = new ItemCBronzeIngot(cc.itemCBronzeIngotID).setUnlocalizedName("CBronzeIngot");
				CBronzePickaxe = new ItemCBronzePickaxe(cc.toolCBronzePickID, celestialBronze).setUnlocalizedName("CBronzePickaxe");
				CBronzeSpade = new ItemCBronzeSpade(cc.toolCBronzeShovelID, celestialBronze).setUnlocalizedName("CBronzeSpade");
				CBronzeSword = new ItemCBronzeSword(cc.toolCBronzeSwordID, celestialBronze).setUnlocalizedName("CBronzeSword");
				DragonTooth = new ItemDragonTooth(cc.itemDragonToothID).setUnlocalizedName("DragonTooth");
				GoldenFleece = new ItemGoldenFleece(cc.itemGoldenFleeceID).setUnlocalizedName("GoldenFleece");
				Nectar = new ItemNectar(cc.itemNectarID).setUnlocalizedName("Nectar");
				PegasusSaddle = new ItemPegasusSaddle(cc.itemPegasusSaddleID).setUnlocalizedName("PegasusSaddle");
				PegasusFeather = new ItemPegasusFeather(cc.itemPegasusFeatherID).setUnlocalizedName("PegasusFeather");
				ReedPipes = new ItemReedPipes(cc.itemReedPipesID).setUnlocalizedName("ReedPipes");
				Thunderbolt = new ItemThunderbolt(cc.itemThunderboltID).setUnlocalizedName("Thunderbolt");
				ThunderPearl = new ItemThunderPearl(cc.itemThunderPearlID).setUnlocalizedName("ThunderPearl");
				Trident = new ItemTrident(cc.itemTridentID).setUnlocalizedName("Trident");
				WaterPearl = new ItemWaterPearl(cc.itemWaterPearlID).setUnlocalizedName("WaterPearl");
	}
