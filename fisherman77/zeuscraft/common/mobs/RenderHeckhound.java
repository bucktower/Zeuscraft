...
public class RenderHeckhound extends RenderLiving
{
	private static final ResourceLocation skin = new ResourceLocation("zeuscraft", "textures/entities/Heckhound.png");

	public RenderHeckhound(ModelBase modelbase, float shadowSize) {
