...
public class EntityPoseidon extends EntityAnimal
{
	public static final ItemStack defaultHeldItem = new ItemStack(Zeuscraft.Trident, 1);
	
 public EntityPoseidon(World world) 
 {
	 super(world);
