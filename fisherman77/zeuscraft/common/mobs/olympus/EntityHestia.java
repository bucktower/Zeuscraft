...
public class EntityHestia extends EntityAnimal
{
	public static final ItemStack defaultHeldItem = new ItemStack(Item.flintAndSteel, 1);
	
 public EntityHestia(World world) 
 {
	 super(world);
