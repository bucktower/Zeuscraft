...
public class EntityDemeter extends EntityAnimal
{
	public static final ItemStack defaultHeldItem = new ItemStack(Zeuscraft.Scepter, 1);
	
 public EntityDemeter(World world) 
 {
	 super(world);
