...
public class EntityAphrodite extends EntityMob
{
	public static final ItemStack defaultHeldItem = new ItemStack(Block.plantRed, 1);
	
 public EntityAphrodite(World world) 
 {
	 super(world);
  ...
  this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true)); 
	...
	protected void func_110147_ax() {
	    ...
	    func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(300); //maxHealth
