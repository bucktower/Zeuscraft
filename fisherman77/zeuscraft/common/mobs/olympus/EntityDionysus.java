...
public class EntityDionysus extends EntityAnimal
{
	public static final ItemStack defaultHeldItem = new ItemStack(Zeuscraft.Grapes, 1);
	
 public EntityDionysus(World world) 
 {
	 super(world);
