...
public class RenderTheseus extends RenderLiving
{
	...
	private static final ResourceLocation skin = new ResourceLocation("zeuscraft", "textures/entities/heroes/theseus.png");
    ...
    //Rendering Name Above Head
        renderLivingLabel(par1EntityLiving, "Theseus", par2, par4 + 0.5D, par6, 64);
    }
