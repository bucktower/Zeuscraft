...
public class EntityAchilles extends EntityAnimal
{
	public static final ItemStack defaultHeldItem = new ItemStack(Item.ingotIron, 1);
	
 public EntityAchilles(World world) 
 {
	 super(world);
