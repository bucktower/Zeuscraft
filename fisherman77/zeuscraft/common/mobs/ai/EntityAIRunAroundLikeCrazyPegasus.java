package fisherman77.zeuscraft.common.mobs.ai;
...
public class EntityAIRunAroundLikeCrazyPegasus extends EntityAIBase
{
    private EntityPegasus field_111180_a;
    private double field_111178_b;
    private double field_111179_c;
    private double field_111176_d;
    private double field_111177_e;

    public EntityAIRunAroundLikeCrazyPegasus(EntityPegasus par1EntityPegasus, double par2)
    {
        this.field_111180_a = par1EntityPegasus;
