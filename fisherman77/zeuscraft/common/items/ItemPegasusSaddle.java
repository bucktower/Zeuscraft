...
public ItemPegasusSaddle(int par1) {
		...
		setUnlocalizedName("PegasusSaddle"); //Sets the incode name of the item, make sure it doesn't clash with other items, weird stuff happens
...
public void updateIcons(IconRegister par1IconRegister)
    {
        this.iconIndex = par1IconRegister.registerIcon("Zeuscraft:PegasusSaddle");
    }
