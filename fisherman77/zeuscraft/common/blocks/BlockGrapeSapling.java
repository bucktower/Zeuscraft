...
public class BlockGrapeSapling extends BlockFlower
{
	...
	public static final String[] WOOD_TYPES = new String[] {"Grape"};
	public BlockGrapeSapling(int i, int j)
	{
		super(i);
		float var3 = 0.4F;
    ...
    {
        blockIcon = iconRegister.registerIcon("zeuscraft:GrapeSapling");
    }
	...
	*/
	public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
	{
			...
			for (i1 = 0; i1 >= -1; --i1)
			{
				for (j1 = 0; j1 >= -1; --j1)
				{
					if (this.isSameSapling(par1World, par2 + i1, par3, par4 + j1, 3) && this.isSameSapling(par1World, par2 + i1 + 1, par3, par4 + j1, 3) && this.isSameSapling(par1World, par2 + i1, par3, par4 + j1 + 1, 3) && this.isSameSapling(par1World, par2 + i1 + 1, par3, par4 + j1 + 1, 3))
					{
						...
						object = new WorldGenGrapeTree(true, 10 + par5Random.nextInt(20), 3, 3, false);
						flag = true;
						break;
					}
				}
		...
		{
			/** Change this to your WorldGenNAMETree **/
			object = new WorldGenGrapeTree(true); // Changed //
