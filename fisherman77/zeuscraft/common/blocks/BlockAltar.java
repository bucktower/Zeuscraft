...
public class BlockAltar extends Block
{
    ...
    private Icon sideIcon;
        ...
        {
                blockIcon = iconRegister.registerIcon("zeuscraft:AltarTopBottom");//Telling Forge where our texture is
                sideIcon = iconRegister.registerIcon("zeuscraft:AltarSide");
        }
        public int idDropped(int i, Random random, int j)
        {
                return Zeuscraft.Altar.blockID;
        }
