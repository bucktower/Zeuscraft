...
public class BlockGrapeLeaves extends BlockLeavesBase implements IShearable
{
    ...
    {
            blockIcon = iconRegister.registerIcon("zeuscraft:GrapeLeavesGrapes");//Telling Forge where our texture is
    }
    ...
    {
        return Zeuscraft.Grapes.itemID;
    }
    ...
    {
        return par1Random.nextInt(10) == 0 ? 2 : 1;
    }
